...
/**
 * This class will handle all armor pieces in the game that protect the torso.
 * @author Zachary House
 * @version 04/10/18
 */
public class Armor_Torso implements Armor
{
     ...
     */
    public Armor_Torso( String name, String description, double armorRating, double weight )
    {
