...
/**
 * This class will handle all armor pieces in the game that protect the upper legs.
 * @author Zachary House
 * @version 04/10/18
 */
public class Armor_UpperLeg implements Armor
{
     ...
     */
    public Armor_UpperLeg( String name, String description, double armorRating, double weight )
    {
