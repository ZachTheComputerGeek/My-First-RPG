...
/**
 * This class will handle all armor pieces in the game that protect the lower legs.
 * @author Zachary House
 * @version 04/10/18
 */
public class Armor_LowerLeg implements Armor
{
     ...
     */
    public Armor_LowerLeg( String name, String description, double armorRating, double weight )
    {
