...
/**
 * This class will handle all armor pieces in the game that protect the hands.
 * @author Zachary House
 * @version 04/10/18
 */
public class Armor_Hands implements Armor
{
     ...
     */
    public Armor_Hands( String name, String description, double armorRating, double weight )
    {
