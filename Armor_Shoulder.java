...
/**
 * This class will handle all armor pieces in the game that protect the shoulder.
 * @author Zachary House
 * @version 04/10/18
 */
public class Armor_Shoulder implements Armor
{
     ...
     */
    public Armor_Shoulder( String name, String description, double armorRating, double weight )
    {
